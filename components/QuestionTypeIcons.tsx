...
type QuestionTypeIconName = "list" | "comment" | "text" | "checkbox" | "star" | "grid" | "slider" | "ranking" | "edit" | "dropdown" | "matrix" | "image" | "name" | "email" | "phone" | "address" | "date";

export function QuestionTypeIcon({ icon, className = "w-5 h-5 text-gray-500 shrink-0" }: { icon: QuestionTypeIconName; className?: string }) {
  switch (icon) {
    case "list":
    ...
    case "text":
      return <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h7" /></svg>;
    case "checkbox":
    ...
    case "slider":
      return <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" /></svg>;
    case "ranking":
