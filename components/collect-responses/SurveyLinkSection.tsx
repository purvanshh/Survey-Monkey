  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <a href="#" className="w-10 h-10 rounded-lg bg-[#5B5FC7] flex items-center justify-center text-white shrink-0" aria-label="Share on Teams">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M11.5 8.5H6.5v8h5v-8zm11-2.5h-5v13h5V6z" /><path d="M2.5 9h-2v7h2V9z" /></svg>
        </a>
